...
func handler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Println(err)
		_, _ = fmt.Fprintf(w, "Image too large. Max Size: %v", maxSize)
		return
	}
	...
	if err != nil {
		log.Println(err)
		_, _ = fmt.Fprintf(w, "Could not get uploaded file")
		return
	}
	defer file.Close()
	...
	_, _ = fmt.Fprintf(w, "Image uploaded successfully: %v", fileName)
}
